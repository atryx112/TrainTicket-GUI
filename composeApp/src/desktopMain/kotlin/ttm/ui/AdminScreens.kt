...
fun AdminDashboardScreen(
    ...
    Column(Modifier.fillMaxSize().padding(24.dp),
        ...
        Divider()
        Text("Tip: In a full UI we’d list stations here to open details directly.")
    }
}
    ...
    Column(Modifier.fillMaxSize().padding(24.dp),
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
            ...
            Button(onClick = {
                ...
                val upd = ttm.domain.Station(id = stationId ?: 0L, name = name, singlePrice = s, returnPrice = r, salesCount = existing?.salesCount ?: 0)
